...
const ProductCard = ({product} : ProductCardProps) => {
  ...
  return (
    <div className='grid justify-center mt-4 mb-4 relative'>
      ...
      <Button className='mt-4 bg-accent-orange rounded-none'>Shop now</Button>
    </div>
  )
}
